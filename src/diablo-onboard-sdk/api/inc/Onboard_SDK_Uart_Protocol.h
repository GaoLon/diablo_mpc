 ...
 *       plit_ctrl_mode (1 bit), 1:control angle    0: control angular velocity \n
...
typedef struct
{
    uint8_t request; //0xAA: Request ENABLE, 0x55: Request DISABLE
    ...
    uint16_t timeout_ms :  15; //automatic release control authority after timeout ms
