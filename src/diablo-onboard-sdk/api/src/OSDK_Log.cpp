...
void Telemetry::statusLog(const OSDK_Push_Data_Status_t& status)
{
    ...
    switch(status.robot_mode)
    {
        ...
        case OSDK_ROBOT_STATE_TRANSITION_DOWN: robotMode = "Transition Down";break;
        case OSDK_ROBOT_STATE_TRANSITION_UP:   robotMode = "Transition Up";break;
        default:                               robotMode = "Disconnect";break;
    }

    cout<<"__status__\n";
    cout<<"ctrl mode:  "<<ctrlMode<<endl
        <<"robot mode: "<<robotMode<<endl
